---
name: explore-skill
description: 当用户需要深入研究论文、综述、topic、系统设计、创新点、机制、claim、公式/模型、实验证据或跨学科问题时使用本 skill，尤其适用于“这篇文章在干什么”“创新点是什么”“解决什么痛点”“机制为什么有效”“证据是否成立”“如何计算/建模”“是否可迁移”等复杂或混合问题。提供表层理解、问题框定、三阶段多轮调研、回答焦点拆解、主 agent 调度子 agent、学术依据查证、证据强度审计、第一性原理/设计哲学/因果机制分析、笔记化压缩和迁移启发提炼。
---
